  ...
  return (
    <View className="flex-1 bg-white">
      <ScrollView contentContainerClassName="pb-10">
        ...
        {/* Hero */}
        <View className="gap-4 bg-amber-soft px-6 pb-10 pt-4">
          <Text className="text-3xl font-extrabold leading-tight tracking-tight text-ink">
            개발 못 해도,{"\n"}기획자로 참여하세요
          </Text>
          ...
          <View className="mt-2 flex-row gap-3">
            <Button
              className="flex-1 items-center rounded-lg bg-amber py-3 shadow-none"
            ...
            <Button
              variant="outline"
              className="flex-1 items-center rounded-lg border-ink py-3 shadow-none"
        ...
        <View className="gap-6 px-6 py-10">
          <View className="gap-1">
            ...
            <Text className="text-xl font-extrabold text-ink">이런 고민 해보신 적 있나요?</Text>
          </View>
        ...
        {/* How it works */}
        <View className="gap-6 bg-gray-50 px-6 py-10">
          <View className="gap-1">
            <Text className="text-xs font-bold uppercase tracking-wide text-amber-deep">How it works</Text>
            <Text className="text-xl font-extrabold text-ink">기획부터 런칭까지, 이렇게 진행됩니다</Text>
          </View>
          <View className="gap-5">
            {STEPS.map((step) => (
              <View key={step.num} className="flex-row gap-3">
                <View className="h-8 w-8 items-center justify-center rounded-full bg-amber">
        ...
        <View className="gap-6 px-6 py-10">
          <View className="gap-1">
            ...
            <Text className="text-xl font-extrabold text-ink">어떤 역할로 참여할 수 있나요?</Text>
          </View>
          <View className="gap-3">
            {ROLES.map((role) => (
              <View key={role.title} className="gap-2 rounded-2xl bg-gray-50 p-5">
                <View className="h-10 w-10 items-center justify-center rounded-full bg-amber-soft">
                  <Text className="text-lg">{role.icon}</Text>
                </View>
        ...
        {/* Final CTA */}
        <View className="gap-3 px-6 pt-6 text-center">
          ...
          <Button
            className="mt-2 items-center rounded-lg bg-amber py-3 shadow-none"
            onPress={() => router.push("/(auth)/signup")}
          >
